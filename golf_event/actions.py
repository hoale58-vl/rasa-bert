...
class ActionNaoSing(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if song_name in list_guitar:
            guitar = "guitar"
        print("speak::::sing::::song/" + song_name + ".mp3" + "::::" + guitar)
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        try:
            ...
            if mode_action == "bật":
                ...
                wsControl.send("mode::::volume::::" + mode_action)
...
class ActionNaoSayText(Action):
    def name(self) -> Text:
        return "action_nao_say_text"
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        say_text = tracker.get_slot('say_text')

        try:
            wsControl = create_connection(wsControlUrl)
            wsControl.send("speak::::" + lang + "::::" + say_text)
            wsControl.close()
        except Exception as e:
            print (e)
